						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="https://phpoll.com/login/process" method="post" role="form" style="display: block;">
									...
									<div class="form-group">
										<input type="password" name="password" id="passwordCreate" tabindex="2" class="form-control" placeholder="Mot de passe">
									</div>
								...
								<form id="register-form" action="registerUser.php" method="post" role="form" style="display: none;">
                                    ...
                                    <div class="form-group">
										<input type="text   " name="adresse" id="adresse" tabindex="1" class="form-control" placeholder="Adresse" value="">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
